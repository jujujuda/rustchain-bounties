...
2. **We pay in RTC, not USD.** RTC is RustChain's native token. Internal reference rate is **$0.15 USD** per 1 RTC. We do not pay in bank transfer, USDC, ETH, or any external currency. If RTC isn't something you want, don't apply — you'll be disappointed.
